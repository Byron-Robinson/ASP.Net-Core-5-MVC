...
namespace CrowdyCloudBar.Repository.Data
{
    public class CrowdyCloudBarDbContext : IdentityDbContext
    {
        public CrowdyCloudBarDbContext(DbContextOptions<CrowdyCloudBarDbContext> options) : base(options) { }
